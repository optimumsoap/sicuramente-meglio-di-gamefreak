...
class Player { //Le classi sono un modello per creare oggetti.
    ...
    update(){
        ...
        this.position.y += this.velocity.x //creazione di una variabile velocità così da permettere di cambiare più agilmente la velocità rispetto ad un semplice y++
